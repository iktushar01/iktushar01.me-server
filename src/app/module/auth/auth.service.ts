...
const registerStudent = async (payload: IRegisterStudent, fileBuffer?: Buffer, fileName?: string) => {
    ...
    try {
        // Create the normal user profile and update the user's image URL in a single transaction
...
const googleLoginSuccess = async (session: {
    ...
    // Lazily create the normal user profile if this is the first Google sign-in
